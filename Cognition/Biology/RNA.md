...
- 相关：[[基因]] — 有些基因的主要产物是具有功能的非编码 RNA
- 相关：[[细胞]] — RNA 参与信息传递、翻译和调控
- 相关：[[转录]] — 转录产生 mRNA、rRNA、tRNA 或其他 RNA
- 相关：[[翻译（生物学）]] — mRNA 把密码子序列带到翻译系统
- 相关：[[酶]] — 某些折叠 RNA 具有催化功能
- 相关：[[核糖体]] — mRNA 为核糖体提供密码子序列
- 相关：[[基因表达]] — 非编码 RNA 也可以是基因表达的最终功能产物
