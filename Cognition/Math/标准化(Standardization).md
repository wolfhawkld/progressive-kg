...
summary: "把不同量纲的数据放到统一的框架里看待——通过 Z-score 变换使特征具有均值为 0、标准差为..."
level: concept
category: Cognition/Math
tags: []
related: [[[归一化(Normalization)]], [[Batch Normalization]], [[梯度下降(Gradient Descent)]], [[特征工程(Feature Engineering)]], [[主成分分析(PCA)]], [[协方差与相关系数]]]
created: 2026-04-29
